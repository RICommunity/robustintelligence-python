...
class RefEvalDatasets(BaseModel):
    """
    ...
    eval_dataset_time_interval: Optional[TimeInterval] = Field(default=None, alias="evalDatasetTimeInterval")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evalDatasetTimeInterval": TimeInterval.from_dict(obj["evalDatasetTimeInterval"]) if obj.get("evalDatasetTimeInterval") is not None else None
        })
        return _obj
