...
class RimeJobDataGenerativeModelTest(BaseModel):
    ...
    progress: Optional[GenerativeModelTestProgress] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": GenerativeModelTestProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "name": obj.get("name"),
            "url": obj.get("url"),
