...
class DataInfo(BaseModel):
    ...
    data_params: Optional[DataParams] = Field(default=None, alias="dataParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataParams": DataParams.from_dict(obj["dataParams"]) if obj.get("dataParams") is not None else None
        })
        return _obj
