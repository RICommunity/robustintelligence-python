...
class GenerativeValidationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "attackTechnique", "attackObjective", "objectiveSubCategory", "failingExamples", "severity", "owaspStandards", "nistStandards", "mitreStandards", "attacksAttempted", "threat", "successfulAttacks", "skippedReason", "testRunId"]
