...
class StartTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "httpHeaders", "endpointPayloadTemplate", "responseJsonPath", "httpAuthIntegrationId", "name", "mutualTlsIntegrationId", "systemPrompt", "awsIntegrationId", "modelId", "body", "workspaceId", "agentId"]
