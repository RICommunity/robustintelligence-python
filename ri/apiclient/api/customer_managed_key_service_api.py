...
class CustomerManagedKeyServiceApi:
    ...
    def create_customer_managed_key(
        self,
        cmk_config: CustomerManagedKeyConfig,
    ...
    def delete_customer_managed_key(
        ...
        :param cmk_config_key_provider:  - KEY_PROVIDER_AWS_KMS: AWS Key Management Service (required)
