...
class ImageRegistryApi:
    ...
    def create_image(
        ...
        :param name: Name of the Managed Image.  Name must match the regexp described in managed_image.proto  for `ManagedImage.name`. (required)
        :type name: str
    ...
    def delete_image(
        ...
        :param name: Name of existing Managed Image to delete.  This name must match the regexp described in managed_image.proto  for `ManagedImage.name`. (required)
        :type name: str
        :return: Returns the result object.
        """ # noqa: E501
    ...
    def get_image(
        ...
        :param name: Name of the existing Managed Image.  Name must match the regexp described in managed_image.proto  for `ManagedImage.name`. (required)
        :type name: str
        :return: Returns the result object.
        """ # noqa: E501
